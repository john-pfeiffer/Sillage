...
const std::vector<Override>& overridesFor (Type type)
{
    ...
    static const std::vector<Override> delayTable {
        { id::time, 375.0f }, { id::density, 24.0f }, { id::spread, 0.0f }, { id::size, 60.0f }, { id::window, 1.0f },
        { id::feedback, 45.0f }, { id::panSpread, 0.0f },
    ...
    static const std::vector<Override> reverbTable {
        { id::time, 80.0f }, { id::density, 200.0f }, { id::spread, 100.0f }, { id::size, 120.0f }, { id::window, 0.0f },
        { id::feedback, 70.0f }, { id::panSpread, 80.0f },
    ...
    static const std::vector<Override> shimmerTable {
        { id::time, 100.0f }, { id::density, 150.0f }, { id::spread, 100.0f }, { id::size, 160.0f }, { id::window, 0.0f },
        { id::feedback, 80.0f }, { id::panSpread, 80.0f },
    ...
    static const std::vector<Override> washTable {
        { id::time, 1200.0f }, { id::density, 60.0f }, { id::spread, 100.0f }, { id::size, 400.0f }, { id::window, 2.0f },
        { id::feedback, 90.0f }, { id::panSpread, 100.0f },
    ...
    static const std::vector<Override> granularTable {
        { id::time, 250.0f }, { id::density, 20.0f }, { id::spread, 60.0f }, { id::size, 40.0f }, { id::window, 3.0f },
        { id::feedback, 55.0f }, { id::panSpread, 70.0f },
